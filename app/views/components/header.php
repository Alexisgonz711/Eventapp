...
<div class="header">
    <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href="index.php">EventApp</a>
        ...
        <ul class="pure-menu-list">
            ...
            if (isset($_SESSION['user'])){
                echo '<li class="pure-menu-item">' .$_SESSION['user'] .'</li>';
                echo '<li class="pure-menu-item"><a href="logout.php" class="pure-menu-link">Se déconnecter</a></li>';
